          ...
          child: Container(
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildDrawerItem(context, Icons.person_add, 'Enrollment', 1),
                _buildDrawerItem(context, Icons.warning, 'Emergency Alert', 2),
                _buildDrawerItem(
                  context,
                  Icons.description,
                  'Health Records',
                ...
                _buildDrawerItem(context, Icons.notifications, 'Reminders', 4),
                _buildDrawerItem(
                  context,
                  Icons.person,
                  'Profile',
                  ...
                  customOnTap: () {
                    ...
                    // Navigator.push(
                    //   context,
                    //   MaterialPageRoute(builder: (context) => ProfileScreen()), // TODO: Define ProfileScreen
                    // );
                  },
                ),
                _buildDrawerItem(
                  ...
                  customOnTap: () {
                    ...
                    //   context,
                    //   MaterialPageRoute(builder: (context) => LoginScreen()), // TODO: Define LoginScreen or handle logout logic
                    // );
                  },
                ),
              ],
